...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600">Buat ujian baru untuk siswa</p>
    </div>
        ...
        <form method="POST" class="p-6 space-y-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="duration_minutes" required value="<?= old('duration_minutes') ?>" min="1"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="e.g., 90">
                </div> <!-- Question Count -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Question Count *</label>
                    <input type="number" name="question_count" id="question_count" required value="<?= old('question_count') ?>" min="1"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="e.g., 20">
                </div><!-- PDF Source -->
                <div class="lg:col-span-2">
                    ...
                    <input type="hidden" name="final_pdf_url" id="final_pdf_url" value="<?= old('pdf_url') ?>">
                </div>
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        if (!finalPdfUrl.value && !pdfUrl.value) {
            e.preventDefault();
            alert('Please parse a PDF first before creating the exam.');
            return false;
        }
    });
</script>
