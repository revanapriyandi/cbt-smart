            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg">
                            <i class="fas fa-plus text-white text-lg"></i>
                        </div>
                    </div>
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Buat Sesi Ujian</h1>
                        <p class="text-gray-600 mt-1">Buat sesi ujian baru dengan pengaturan yang detail dan terjadwal</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-5">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-white">Buat Sesi Ujian Baru</h2>
                        <p class="text-purple-100 text-sm">Lengkapi informasi untuk membuat sesi ujian yang terorganisir</p>
                    </div>
                </div>
            </div>

            <form method="POST" action="<?= base_url('admin/exam-sessions/create') ?>" class="p-8" id="createSessionForm">
                <?= csrf_field() ?>
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between relative">
                        <div class="flex items-center space-x-2">
                            <div class="w-10 h-10 bg-purple-600 text-white rounded-full flex items-center justify-center font-semibold shadow-lg">
                                <i class="fas fa-info-circle text-sm"></i>
                            </div>
                            <span class="text-sm font-semibold text-purple-600">Informasi Dasar</span>
                        </div>
                        <div class="flex-1 mx-4 h-1 bg-gray-200 rounded">
                            <div class="h-full bg-purple-600 rounded w-1/3"></div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <div class="w-10 h-10 bg-orange-500 text-white rounded-full flex items-center justify-center font-semibold shadow-lg">
                                <i class="fas fa-clock text-sm"></i>
                            </div>
                            <span class="text-sm font-semibold text-orange-600">Jadwal & Pengaturan</span>
                        </div>
                        <div class="flex-1 mx-4 h-1 bg-gray-200 rounded">
                            <div class="h-full bg-orange-500 rounded w-2/3"></div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <div class="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center font-semibold shadow-lg">
                                <i class="fas fa-cog text-sm"></i>
                            </div>
                            <span class="text-sm font-semibold text-green-600">Pengaturan Lanjutan</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="exam_id" name="exam_id"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <label class="relative flex cursor-pointer rounded-lg border-2 p-4 hover:shadow-md transition-all duration-200 <?= old('security_settings', 'normal') === 'relaxed' ? 'border-green-500 bg-green-50 shadow-md' : 'border-gray-300 hover:border-green-400' ?>">
                                        <input type="radio" name="security_settings" value="relaxed" class="sr-only" <?= old('security_settings') === 'relaxed' ? 'checked' : '' ?>>
                                    ...
                                    <label class="relative flex cursor-pointer rounded-lg border-2 p-4 hover:shadow-md transition-all duration-200 <?= old('security_settings', 'normal') === 'normal' ? 'border-blue-500 bg-blue-50 shadow-md' : 'border-gray-300 hover:border-blue-400' ?>">
                                        <input type="radio" name="security_settings" value="normal" class="sr-only" <?= old('security_settings', 'normal') === 'normal' ? 'checked' : '' ?>>
                                        <div class="flex flex-col items-center text-center w-full">
                                    ...
                                    <label class="relative flex cursor-pointer rounded-lg border-2 p-4 hover:shadow-md transition-all duration-200 <?= old('security_settings') === 'strict' ? 'border-red-500 bg-red-50 shadow-md' : 'border-gray-300 hover:border-red-400' ?>">
                                        <input type="radio" name="security_settings" value="strict" class="sr-only" <?= old('security_settings') === 'strict' ? 'checked' : '' ?>>
                                        <div class="flex flex-col items-center text-center w-full">
                ...
                <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="<?= base_url('admin/exam-sessions') ?>"
                            class="inline-flex items-center px-6 py-3 bg-white border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-200">
                            <i class="fas fa-times mr-2"></i>
                            Batal
                        </a>
                        <button type="submit"
                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white hover:from-purple-700 hover:to-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-200">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (startTime <= now) {
                e.preventDefault();
                showNotification('Waktu mulai harus di masa depan', 'error');
